  ...
  return (
    <div className="min-h-[calc(100vh-64px)] lg:px-14 sm:px-8 px-4">
      <div className="lg:flex-row flex-col lg:py-5 pt-16 lg:gap-10 gap-8 flex justify-between items-center">
        <div className="flex-1">
          <h1 className="font-bold font-roboto text-slate-800 md:text-5xl text-3xl md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full">
            Linkit Simplifies URL Shortening for Efficient Sharing
          </h1>
          <p className="text-slate-700 text-sm my-5">
            Simplify your sharing with Linkit today!
          </p>
        ...
        <div className="flex-1 flex justify-center w-full">
          <img
            ...
            src="/images/icon_placeholder.png"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="sm:pt-12 pt-7">
        <p className="text-slate-800 font-roboto font-bold lg:w-[60%] md:w-[70%] sm:w-[80%] mx-auto">
          Safe and secure
        </p>
